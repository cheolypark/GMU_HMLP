...
public class hmlp_text_mode_heater_discrete2 {

	public hmlp_text_mode_heater_discrete2() {
	}
	...
	public void run() {
		...
		childMNode = "slabinput_item.SII_grade";
		parentMNodes = new ArrayList<String>();
		parentMNodes.add("slabinput_item.SII_volume");	// Discrete		 
		mTheory.addParents(childMNode, parentMNodes);
...
//		System.out.println(mTheory.toString("MFrag", "MNode")); 
	...
	public static void main(String[] args) {
		hmlp_text_mode_heater_discrete2 h = new hmlp_text_mode_heater_discrete2();
		h.run();
	} 
}
